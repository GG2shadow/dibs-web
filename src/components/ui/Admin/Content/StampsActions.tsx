...
export function StampsActions() {
  ...
  async function createTransaction(props: {
    ...
    try {
      ...
      // You can use `data` if your function returns a result
  ...
  return (
    <div className="w-1/2 pl-1">
      ...
      <p className="text-muted-foreground text-sm">
        This is where you can give your customers stamps or redeem their
        rewards.
      </p>
      <div className="flex items-center py-4">
        <form className="w-full space-y-6">
          ...
          <div className="space-y-4">
            ...
            {/* Campaign Selection */}
            <div className="space-y-2">
              <Label htmlFor="campaign" className="font-['Inter']">
                Campaign
              </Label>
              <Select>
              ...
              <div className="w-full">
                <Tabs defaultValue="give-stamps" className="w-full">
                  <TabsList className="grid w-1/2 grid-cols-2">
                    ...
                    <TabsTrigger value="redeem-rewards">
                      Redeem Rewards
                    </TabsTrigger>
                  </TabsList>
                  <TabsContent value="give-stamps">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Give stamps according to the purchase value. Any
                          doubts kindly approach supervisor.
                        </CardDescription>
                      </CardHeader>
