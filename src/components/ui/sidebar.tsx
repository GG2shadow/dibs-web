  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'bg-sidebar text-sidebar-foreground flex h-full w-[--sidebar-width] min-w-[--sidebar-width] flex-col',
            className,
          )}
          ref={ref}
          {...props}
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'md:peer-data-[variant=inset]:m-3 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-3',
        className,
      )}
      {...props}
    />
